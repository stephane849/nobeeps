...
export function Avatar({ initials, filled, square, size }) {
  const cls = ["avatar"];
...
export function NetGlyph({ network, size = 24 }) {
  const box = {
...
export function Keyboard({ onKey, onSpace, onDelete, onSend, shift, onShift }) {
  return (
